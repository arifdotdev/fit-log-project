...
// The parent (Libraries) fetches the list once and passes each workout down,
// so this card never calls the API itself.
const WorkOutCard = ({ library }: WorkOutCardProps) => {
    return (
        <Link href={`/workout/${library.id}`} className="group">
